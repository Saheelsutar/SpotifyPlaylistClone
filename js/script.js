...
async function getSongs(folder) {
    currfolder = folder;
    let a = await fetch(`https://saheelsutar.github.io/SpotifyPlaylistClone/${folder}/`);
    ...
    for (const song of songs) {
        songUl.innerHTML += `<li>
            <img class="invert" src="https://saheelsutar.github.io/SpotifyPlaylistClone/img/music.svg" alt="">
            <div class="info">
            ...
            <div class="playnow">
                <span>Play Now</span>
                <img class="invert" src="https://saheelsutar.github.io/SpotifyPlaylistClone/img/play.svg" alt="">
            </div>
        </li>`;
    }
...
const playMusic = (track, pause = false) => {
    currentSong.src = `https://saheelsutar.github.io/SpotifyPlaylistClone/${currfolder}/` + track;
    if (!pause) {
        currentSong.play();
        play.src = "https://saheelsutar.github.io/SpotifyPlaylistClone/img/pause.svg";
    }
...
async function displayAlbums() {
    let a = await fetch("https://saheelsutar.github.io/SpotifyPlaylistClone/songs/");
    let response = await a.text();
    let div = document.createElement('div');
    div.innerHTML = response;
...
async function main() {
    ...
    play.addEventListener("click", () => {
        if (currentSong.paused) {
            ...
            currentSong.pause();
            play.src = "https://saheelsutar.github.io/SpotifyPlaylistClone/img/play.svg";
        }
    });
